...
export async function List(data: Record<string, any>) {
    ...
    try {
        const response = await fetch(URL + "/satuan/list", {
            method: 'POST',
...
export async function Create(data: Record<string, any>) {
    ...
    try {
        const response = await fetch(URL + "/satuan/create", {
            method: 'POST',
            body: JSON.stringify(data),
            headers: new Headers({
                'Content-Type': 'application/json',
...
export async function Update(data: Record<string, any>) {
    ...
    try {
        const response = await fetch(URL + "/satuan/update/" + data['id'], {
            method: 'PUT',
            body: JSON.stringify(data),
            headers: new Headers({
                'Content-Type': 'application/json',
...
export async function Delete(data: Record<string, any>) {
    ...
    try {
        const response = await fetch(URL + "/satuan/delete/" + data['id'], {
            method: 'DELETE',
            body: JSON.stringify(data),
            headers: new Headers({
                'Content-Type': 'application/json',
